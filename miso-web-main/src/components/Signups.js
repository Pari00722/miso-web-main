...
<form onSubmit={isCodeSent ? handleVerifyCode : handleSignup}
...
required
/>
<button type="submit" className="submit-button">Verify and Sign
Up</button>
</>
)}
{!isCodeSent && (
<button type="submit" className="submit-button">Send Verification
Code</button>
)}
</form>
<p className="already-have-account">Already have an account? <a
