    ...
    <div className="jsMainParent">
      <div className="jsLeft text-center">
        ...
        <p className="mt-8 text-2xl">
          Welcome to our gifting journal! Discover creative ideas and
          inspiration for choosing the perfect gifts for every occasion. From
          unique gift guides and DIY projects to stories behind our handcrafted
          products, our journal is your go-to source for all things gifting.
        </p>
      ...
      <div className="jsRight flex flex-col sm:flex-row gap-20">
        ...
        <div className="group text-center">
          <Link to={`/journal/gift-guides`}>
            <img
              src="/assets/journalimg1.png"
              alt="Gift Guides"
              className="jsImg rounded-xl transform transition-transform duration-300 group-hover:scale-105 ml-12"
            />
          </Link>
        ...
        <div className="group text-center">
          <Link to={`/journal/diy-projects`}>
            <img
              src="/assets/journalimg2.png"
              alt="DIY Projects"
              className="jsImg rounded-xl ml-12 transform transition-transform duration-300 group-hover:scale-105"
            />
          </Link>
